    ...
    <div className="px-20 flex items-center pb-18 justify-between">
      ...
      <div className="flex flex-col w-[750px] mr-12">
        ...
        <span data-aos="fade-right" className="text-white py-5 text-[20px]/[33px] font-montserrat">
          ...
          chain. Leveraging Biturbo's infrastructure, TurboAnchor aims to create
          an innovative stablecoin that enhances capital efficiency in DeFi.
        </span>
        <Button
          variant={'outline'}
          className="w-[227px] h-[68px] mt-4 rounded-[36px]"
        >
          View Whitepaper
        </Button>
      </div>
