  ...
  return (
    <div className="flex py-10 flex-col">
      <div className="max-w-[900px] mb-6 flex items-center justify-center flex-col mx-auto">
        <Button
          variant={'primary'}
          className="w-[229px] h-[77px] rounded-[37px] text-[20px]"
        >
          {' '}
          Our Features
        </Button>
        <h2 className="text-white py-6 text-center text-[28px]/[30px]">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="flex flex-col w-[433px]">
                <h2 className="mb-3 font-montserrat font-bold text-[20px]/[30px]">
                  {feature.header}
                </h2>
                <span className="text-gray-200 text-[16px]/[22px] font-nunito">
                  {feature.content}
                </span>
              </div>
            </div>
